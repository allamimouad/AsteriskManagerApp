<?php
    ...
    $icon = '<a href=""> <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-telephone-plus " fill="red" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="row  border border-dark rounded">
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 text-success"> <?= $client->getExtension() == null ? $icon : $client->getExtension()->getExtension() ?> </div>
